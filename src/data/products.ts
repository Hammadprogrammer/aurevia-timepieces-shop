...
const rows: Row[] = [
  ...
  // ---------------- Sports ----------------
  { n: "Trailhead Tactical 44", b: "Northmark", c: "sports", col: "Trailhead", p: 11999, o: 16999, r: 4.7, rv: 322, s: 27, mv: "Solar Quartz", cm: "Carbon-Reinforced Resin", cs: "44mm", wr: "20 ATM", cl: ["Black", "Desert Tan", "Olive"], st: ["Resin", "NATO Nylon"], d: "Solar-charged, shock-mounted and legible at a glance in the worst possible light.", f: true },
